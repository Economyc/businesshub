...
const NAV_RESULTS: SearchResult[] = [
  ...
  { id: 'nav-talent', type: 'navigation', label: 'Talento', icon: <Users size={ICON_SIZE} strokeWidth={STROKE} />, to: '/talent', keywords: 'empleados personas equipo recurso humano nomina' },
