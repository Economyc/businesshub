...
export declare const POS_DOMAIN_ID = "8267";
...
export declare function fetchDominio(token: string): Promise<PosDominioResult>;
export interface FetchAllPagesResult {
    ventas: unknown[];
    rateLimited: boolean;
    requestCount: number;
}
export declare function fetchAllPagesForLocal(token: string, localId: number, f1: string, f2: string): Promise<FetchAllPagesResult>;
export declare function fetchCatalogo(token: string, localId: number): Promise<unknown[]>;
