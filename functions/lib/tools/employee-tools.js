...
export function createEmployeeTools(companyId) {
    return {
        getEmployees: tool({
            ...
            execute: async ({ department, status }) => {
                ...
                if (department) {
                    filtered = filtered.filter((e) => String(e.department).toLowerCase() === department.toLowerCase());
                }
                if (status) {
...
//# sourceMappingURL=employee-tools.js.map