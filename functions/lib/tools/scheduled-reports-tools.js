...
export function createScheduledReportsTools(companyId) {
    return {
        listScheduledReports: tool({
            description: 'Lista los reportes programados (P&L, ventas, gastos, ejecutivo) de la compañía activa. Útil cuando el usuario pregunta "qué reportes recibo automáticamente".',
            parameters: z.object({
                enabledOnly: z
                    .boolean()
                    .optional()
        ...
        createScheduledReport: tool({
            description: 'Crea un nuevo reporte programado (P&L semanal, resumen diario, etc.). NO ejecuta — el cliente pide confirmación al usuario antes de guardar.',
            parameters: z.object({
        ...
        toggleScheduledReport: tool({
            description: 'Activa o desactiva un reporte programado existente. NO ejecuta — el cliente pide confirmación.',
            parameters: z.object({
        ...
        deleteScheduledReport: tool({
            description: 'Elimina un reporte programado. NO ejecuta — el cliente pide confirmación al usuario.',
            parameters: z.object({
...
//# sourceMappingURL=scheduled-reports-tools.js.map