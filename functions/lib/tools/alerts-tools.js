...
// ─── Tools ───
export function createAlertsTools(companyId) {
    return {
        getBusinessAlerts: tool({
            description: 'Genera alertas proactivas del negocio: contratos por vencer, empleados en período de prueba, presupuesto excedido, transacciones vencidas, proveedores con contratos expirados.',
            parameters: z.object({
...
//# sourceMappingURL=alerts-tools.js.map