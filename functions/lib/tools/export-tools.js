...
export function createExportTools() {
    return {
        exportReport: tool({
            description: 'Exporta un reporte a PDF o Excel. Usa esta herramienta DESPUÉS de generar datos con otra herramienta. Envía los datos ya procesados para que el frontend genere el archivo.',
            parameters: z.object({
