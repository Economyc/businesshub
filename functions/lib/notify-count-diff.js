...
export const notifyCountDiff = onCall({ region: 'us-central1', memory: '256MiB', timeoutSeconds: 30, secrets: [telegramBotToken] }, async (request) => {
    if (!request.auth)
...
//# sourceMappingURL=notify-count-diff.js.map