...
export const agentChat = onRequest({
    ...
    try {
        const { messages, companyId, companies, userMemory, inlineContext, 
        ...
        threadId, threadTitle, threadContext, nextActions, userId, conversationId, } = req.body;
                        ...
                        thread: typeof threadTitle === 'string' && threadTitle.trim().length > 0
                            ? {
                                ...
                                nextActions: Array.isArray(nextActions)
                                    ? nextActions.filter((a) => typeof a === 'string')
                                    : [],
                            }
                            : null,
                    }),
