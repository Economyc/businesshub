...
export function createMutationTools() {
  return {
    ...
    updateTransaction: tool({
      description:
        'Actualiza una transacción financiera existente en el módulo Facturación. Requiere confirmación del usuario. ' +
    ...
    quickMarkInvoiceAsPaid: tool({
      description:
        'Marca una factura pendiente como pagada SIN adjuntar comprobante. Atajo rápido (equivalente al toggle ' +
    ...
    bulkMarkAsPaid: tool({
      description:
        'Marca varias facturas pendientes como pagadas en una sola operación, sin adjuntar comprobantes. ' +
    ...
    bulkSetPriority: tool({
      description:
        'Cambia la prioridad de varias facturas/compras pendientes en una sola operación. Útil para "marca como ' +
