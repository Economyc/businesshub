...
export type CompanyResolution =
  ...
  | { ok: false; reason: 'ambiguous'; matches: CompanyInfo[] }
...
export function resolveCompany(input: string, companies: CompanyInfo[]): CompanyResolution {
  ...
  type Scored = { company: CompanyInfo; matched: number; haySize: number }
