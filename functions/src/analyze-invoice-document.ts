...
interface AnalyzeInput {
  ...
  fileBase64: string
  mimeType: string
  // 'receivable' = cuenta de cobro emitida a un cliente (Cuentas por Cobrar,
  // app Ecore). Matchea contra el catálogo `customers` en vez de `suppliers`.
  kind: 'invoice' | 'purchase' | 'receivable'
}
